...
f = open(r"C:\streamlit\churn\gemini api key.txt")
api_key = f.read()
...
st.title("🔎An Advanced RAG System Based on Leave No Context Behind Paper📄")

st.subheader("💬Let AI Help You Quickly Find What You Need in Your PDFs using RAG 🤖")
...
# Loading Document
loader = PyPDFLoader(r"C:\google gemini\Leave no context behind.pdf")
